(() => {
  ...
  // .wrangler/tmp/bundle-oiSZha/middleware-insertion-facade.js
  ...
  async function handleRequest(request) {
    ...
    if (request.method === "GET" && url.pathname.startsWith("/files/")) {
      ...
      try {
        ...
        const contentType = object.httpMetadata?.contentType || (extension === "wasm" ? "application/wasm" : extension === "pdf" ? "application/pdf" : extension === "step" || extension === "stp" ? "application/octet-stream" : "application/octet-stream");
